    ...
    var flag=0
      ...
      if(output === 'aadhar')
      {
        if(proofValue.length!=16)
          flag=1
        document.getElementById("id-proof-error").innerText = "enter Aadhar correctly"
      ...
      }else if(output === 'passport')
      {
        ...
        document.getElementById("id-proof-error").innerText = "enter passport correctly"
        for(var i=0;i<proofValue.length;i++){
          if(i==0){
            if(proofValue.charAt(i)<'A' || proofValue.charAt(i)>'Z'){
              document.getElementById("id-proof-error").innerText = "enter the passport correctly"
              flag=1
            }
          }else{
            if(proofValue.charAt(i)<'0' || proofValue.charAt(i)>'9')
            document.getElementById("id-proof-error").innerText = "enter driving license number correctly"
            flag=1
        ...
        document.getElementById("id-proof-error").innerText = "enter DL number correctly"
        for(var i=0;i<proofValue.length;i++){
          if(i==0 || i==1){
            if(proofValue.charAt(i)<'A' || proofValue.charAt(i)>'Z'){
              document.getElementById("id-proof-error").innerText = "enter DL number correctly"
